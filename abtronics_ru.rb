...
#Pry.start(binding)
    ...
    1.upto(20).each do |i|
      ...
      begin
          ...
          csv << [id, comp, sh_categ, sh_man, link, name, category, manufact, short_descr, sklad, srok, quantity, price, description, image1, image2, image3, image4, image5, pdf1, pdf2, pdf3, pdf4, pdf5, image1f, image2f, image3f, image4f, image5f, pdf1f, pdf2f, pdf3f, pdf4f, pdf5f]
          id += 1
      rescue; end
    end
  end
